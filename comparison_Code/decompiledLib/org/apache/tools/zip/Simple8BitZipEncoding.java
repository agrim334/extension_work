  ...
  implements ZipEncoding
{
  ...
  public Simple8BitZipEncoding(char[] highChars)
  {
    ...
    {
      code = (byte)(code + 1);temp.add(new Simple8BitChar(code, highChar));
    }
  ...
  private Simple8BitChar encodeHighChar(char c)
  {
    ...
    while (i1 > i0)
    {
      ...
      Simple8BitChar m = (Simple8BitChar)reverseMapping.get(i);
      if (unicode == c) {
        return m;
      }
      if (unicode < c) {
    ...
    Simple8BitChar r = (Simple8BitChar)reverseMapping.get(i0);
    if (unicode != c) {
      return null;
    }
    return r;
...
/* Location:
 * Qualified Name:     org.apache.tools.zip.Simple8BitZipEncoding
