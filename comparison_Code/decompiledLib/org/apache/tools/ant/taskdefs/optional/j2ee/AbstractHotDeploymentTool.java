  ...
  implements HotDeploymentTool
{
    ...
    throws BuildException
  {
    ...
    if (!isActionValid()) {
      throw new BuildException("Invalid action \"%s\" passed", new Object[] { task.getAction() });
    }
    if (classpath == null) {
...
/* Location:
 * Qualified Name:     org.apache.tools.ant.taskdefs.optional.j2ee.AbstractHotDeploymentTool
