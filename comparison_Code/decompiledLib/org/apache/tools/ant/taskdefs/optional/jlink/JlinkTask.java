  ...
  extends MatchingTask
{
  ...
  {
    if (mergefiles == null) {
      mergefiles = new Path(getProject());
    }
    return mergefiles.createPath();
  }
  ...
  {
    if (addfiles == null) {
      addfiles = new Path(getProject());
    }
    return addfiles.createPath();
  }
...
/* Location:
 * Qualified Name:     org.apache.tools.ant.taskdefs.optional.jlink.JlinkTask
