...
public class CollectionUtils
{
  ...
  private static <E> int getFreq(E obj, Map<E, Integer> freqMap)
  {
    try
    {
      Integer o = (Integer)freqMap.get(obj);
      if (o != null) {
        return o.intValue();
      }
    }
    catch (NullPointerException localNullPointerException) {}catch (NoSuchElementException localNoSuchElementException) {}
    return 0;
  }
}

/* Location:
 * Qualified Name:     org.codehaus.plexus.util.CollectionUtils
