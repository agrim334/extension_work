  ...
  private static final String buildRelativePath(String toPath, String fromPath, char separatorChar)
  {
    ...
    while ((toTokeniser.hasMoreTokens()) && (fromTokeniser.hasMoreTokens()))
    {
      if (separatorChar == '\\' ? 
        ...
        !fromTokeniser.nextToken().equalsIgnoreCase(toTokeniser.nextToken()) : 
        
        !fromTokeniser.nextToken().equals(toTokeniser.nextToken())) {
        break;
      }
      count++;
    }
...
/* Location:
 * Qualified Name:     org.codehaus.plexus.util.PathTool
