  ...
  extends Reader
{
    ...
    throws IOException
  {
    ...
    if (ex != null)
    {
      ...
      if (encoding == null) {
        encoding = _defaultEncoding == null ? "UTF-8" : _defaultEncoding;
      }
  ...
  private String calculateHttpEncoding(String cTMime, String cTEnc, String bomEnc, String xmlGuessEnc, String xmlEnc, InputStream is, boolean lenient)
    throws IOException
  {
    String encoding;
      ...
      if ((appXml) || (textXml))
      {
        ...
        if (cTEnc == null)
        {
          ...
          if (appXml) {
            ...
            encoding = _defaultEncoding == null ? "US-ASCII" : _defaultEncoding;
          }
        }
        else
        {
...
/* Location:
 * Qualified Name:     org.codehaus.plexus.util.xml.XmlReader
