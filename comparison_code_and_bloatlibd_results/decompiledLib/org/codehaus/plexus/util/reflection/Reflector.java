...
public final class Reflector
{
    ...
    throws ReflectorException
  {
    ...
    {
      Constructor<T> constructor = (Constructor)constructorMap.get(paramKey);
      if (constructor == null)
      {
        Constructor<T>[] cands = (Constructor[])targetClass.getConstructors();
  ...
  private Method _getMethod(Class targetClass, String methodName, Class[] params)
    throws ReflectorException
  {
    Map<String, Method> methodMap = getMethodMap(targetClass, methodName);
    ...
    synchronized (paramKey.intern())
    {
      Method method = (Method)methodMap.get(paramKey);
      if (method == null)
      {
  ...
  private <T> Map<String, Constructor<T>> getConstructorMap(Class<T> theClass)
    throws ReflectorException
  {
    return getMethodMap(theClass, "$$CONSTRUCTOR$$");
  }
    ...
    throws ReflectorException
  {
    ...
    {
      Map<String, Map<String, Method>> classMethods = (Map)classMaps.get(className);
      ...
      else
      {
        ...
        {
          Map<String, Method> methodMap = (Map)classMethods.get(methodName);
          if (methodMap == null)
          {
...
/* Location:
 * Qualified Name:     org.codehaus.plexus.util.reflection.Reflector
