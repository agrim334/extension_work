...
public abstract class CommandLineUtils
{
  ...
  public static CommandLineCallable executeCommandLineAsCallable(Commandline cl, InputStream systemIn, final StreamConsumer systemOut, final StreamConsumer systemErr, final int timeoutInSeconds)
    throws CommandLineException
  {
    if (cl == null) {
    ...
    new CommandLineCallable()
    {
        ...
        throws CommandLineException
      {
        ...
        try
        {
          ...
          {
            inputFeeder = new StreamFeeder(val$systemIn, p.getOutputStream());
            inputFeeder.start();
          }
          ...
          else
          {
            ...
            if (CommandLineUtils.isAlive(p)) {
              throw new InterruptedException(String.format("Process timed out after %d seconds.", new Object[] { Integer.valueOf(timeoutInSeconds) }));
            }
  ...
  private static void handleException(StreamPumper streamPumper, String streamName)
    throws CommandLineException
  {
  ...
  private static void handleException(StreamFeeder streamFeeder, String streamName)
    throws CommandLineException
  {
...
/* Location:
 * Qualified Name:     org.codehaus.plexus.util.cli.CommandLineUtils
